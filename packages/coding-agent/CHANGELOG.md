...
- Fixed extension discovery to dedup by symlink target so a symlinked extension and its resolved target are not loaded twice (which double-registered flags/commands).
