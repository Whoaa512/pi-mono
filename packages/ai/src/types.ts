...
export interface OpenAICompletionsCompat {
	...
	/** Disable automatic Anthropic-style `cache_control` breakpoints. By default, breakpoints are injected when the model id contains `anthropic` or `claude`. Set to true for proxies that reject unknown fields. Default: false. */
	disableAnthropicCacheControl?: boolean;
}
